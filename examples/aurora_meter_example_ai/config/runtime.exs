...
#
#     PHX_SERVER=true bin/aurora_meter_example_ai start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :aurora_meter_example_ai, AuroraMeterExampleAiWeb.Endpoint, server: true
end
  ...
  config :aurora_meter_example_ai, AuroraMeterExampleAiWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/aurora_meter_example_ai_web/router\.ex$"E,
        ~r"lib/aurora_meter_example_ai_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :aurora_meter_example_ai, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :aurora_meter_example_ai, AuroraMeterExampleAi.Mailer,
