defmodule AuroraMeter.Migration do
  ...
  Fresh install (generated by `mix aurora_meter.gen.migration`):
      ...
      def up, do: AuroraMeter.Migration.up(from: 1, version: 8, concurrently: false)
      def down, do: AuroraMeter.Migration.down(version: 8, to: 1, confirm_data_loss: true)
